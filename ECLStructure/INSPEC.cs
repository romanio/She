    ...
    public class INSPEC
    {
        ...
        public INSPEC(string filename)
        {
            ...
            if (br.Length > 0)
            {
                ...
                {
                    br.ReadHeader();
                    System.Diagnostics.Debug.WriteLine("INSPEC:  " + br.header.keyword + " (" + br.header.count + ") " + br.header.type);
        ...
        public void ReadACTNUM(string filename)
        {
            ...
            if (br.Length > 0)
            {
                ...
                {
                    br.ReadHeader();
                    System.Diagnostics.Debug.WriteLine("INIT:  " + br.header.keyword + " (" + br.header.count + ") " + br.header.type);
